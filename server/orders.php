...
<head>
    ...
    <table align="center" style="border:1px solid black; padding:5%;color:white; border-collapse: collapse;">
            <tr>
                <th style="border:1px solid black; padding:auto; color:black; border-collapse: collapse;">Book Name</th>
        ...
        <?php
            ...
            $email = $_POST['email'];
            $sql = "SELECT * FROM getBook WHERE email = '$email'";
            ...
            ?>
            <tr>
                <td style="border:1px solid black; padding:auto; border-collapse: collapse;color:blue;"><?php echo $row['bookName']."<br>";?></td>
     ...
     <h3 class="back">Fetching Successful <a href="./orders.html">Go back</a><br>
                  <a class="back" href="../index.html">Home</a></h3>
